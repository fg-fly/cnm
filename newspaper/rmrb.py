...
def rmrb():
    ...
    index_content = 1
    for i in title_list:
        _url = 'http://paper.people.com.cn/rmrb'
        _real_url = _url + i.get("href")[-38:]
        rmrb_pdf = requests.get(_real_url)
        content = rmrb_pdf.content
        file_name = '人民日报' + str(index_content) + '.pdf'
...
rmrb()
compress_file('人民日报.zip', '/Users/Tuoxian/PycharmProjects/demo/test/报刊/人民日报')      # 执行函数
